...
class ImageDataset(Dataset):
    def __init__(self, data_dirs, mode=0):
        ...
        for i in data_dirs:
            ...
            json_file = [f for f in os.listdir(i) if f.endswith('.json')][0]
...
def get_dataloader(data_location):
    ...
    return [DataLoader(ImageDataset(data_set[:train_number], mode=0), batch_size=8, shuffle=True),
            DataLoader(ImageDataset(data_set[train_number:], mode=1), batch_size=8, shuffle=True)]
